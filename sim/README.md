...
- **Full-wave layout EM (openEMS + gerber2ems):** separate path under **[`emi/`](../emi/README.md)** — Docker image + CI fixture for upstream **`stub_short`**; complements ngspice here; same **non–chamber-sign-off** boundary as **[PRD #43](https://github.com/eshelton328/the-forge/issues/43)**.
