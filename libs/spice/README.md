...
- **SHA256** (committed `TPS63070_TRANS.LIB`; recompute after any edit):\
  `46fbb6eb588748d168626652e5164af863b3a3bfc9efa833b29289b38f311f62`
...
- **UVLO (transient):** Enable logic treats the input as **max(VIN_0, VIN_1)** vs GND so undriven pins (leaking toward PGND through the subckt’s megohm pin stubs) do not disable the model when the energized rail is above threshold; hardware should still tie both VIN pins per the datasheet.
