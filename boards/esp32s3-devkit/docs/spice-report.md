...
| --- | --- | --- | --- |
| VBAT_SW rail DC bias (4.8 V pack at t=0) | 4.8 | min 4.5, max 4.85 | **PASS** |
...
| Vout ripple peak-peak, fresh pack idle | 0 | max 0.15 | **PASS** |
...
| VBAT_SW rail present during worst burst (wiring check) | 3.00011 | min 2.5 | **PASS** |
| Battery-side passive drain (pull-ups + FB divider; TI model is quasi-ideal and does not draw converter input current) | 0.000190498 | max 0.002 | **PASS** |
