...
- **Open EMS / gerber2ems** — optional path-filtered workflow ([`.github/workflows/emi-checks.yml`](.github/workflows/emi-checks.yml)): builds pinned **openEMS** + **gerber2ems** and runs an upstream example slice ([`emi/README.md`](emi/README.md)); not every PR
